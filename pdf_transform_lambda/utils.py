...
def wait_for_pdf_upload(bucket_name: str, s3_client: boto3.client, folder_name: str) -> str:
    '''
    ...
    try:
        ...
        waiter.wait(Bucket=bucket_name, Key=cloud_pdf_key, WaiterConfig={'Delay': 1, 'MaxAttempts': 3})
...
def upload(bucket_name, s3_client, folder_name, image_paths):
    '''
    ...
    for local_img_file in image_paths:
        ...
        try:
            s3_client.upload_file(local_img_file, bucket_name, cloud_image_path)
        except Exception as e:
